...
aal_maps= load_img("/home/user/AAL3/AAL3v1.nii.gz")
aal_resampled=resample_to_img(aal_maps,m_img,interpolation="nearest", copy_header=True)

index = pd.read_csv("/home/user/AAL3/AAL3v1.nii.txt", sep = " ", names= ["Index", "Region", "Label"] ,  index_col=0 )
#index.iloc[1][2]
...
print("hippocampal masks created", flush=True)
...
all_masks = [hippo_map_L, hippo_map_R]
all_masks_names = ["hippocampus_L", "hippocampus_R"]
